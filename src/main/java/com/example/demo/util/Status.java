...
public enum Status {
    ...
    Status(String statusCode, String successDescription) {
        this.statusCode = statusCode;
        this.statusDescription = successDescription;
    }

    public static Status getCCStatus(String statusCode) {
        for (Status ccStatus : Status.values()) {
    ...
    public boolean isSuccess() {
        return this.statusCode.equals(Status.SUCCESS.statusCode);
    }
}
